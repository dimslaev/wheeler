!(function(e, t) {
  ...
  function s() {
    ...
    var e = performance.now(),
      t = event.wheelDelta || -event.deltaY || -event.detail,
  ...
  function d() {
    event.preventDefault(),
      ...
      i &&
        Math.abs(u - a) > (window.innerHeight / 100) * n.touchSensitivity &&
        (a < u ? v("down") : u < a && v("up"));
  }
  function v(e) {
    (i = !1),
      n.onScrollStart && n.onScrollStart(e, o),
      setTimeout(function() {
        (i = !0),
          (function(e) {
            "down" === e && "down" === r && h(o + 1, !0);
            "up" === e && "up" === r && h(o - 1, !0);
          })((r = e)),
          n.onScrollEnd && n.onScrollEnd(e, o);
      }, n.scrollDuration + 30);
  }
  function h(e, t) {
    e <= n.maxScrollCount && e >= n.minScrollCount
      ? (o = e)
      : t || console.error("Scroll count" + e + "falls outside min-max range.");
  }
  function w() {
